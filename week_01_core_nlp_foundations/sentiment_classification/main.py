...
if __name__ == '__main__': 
    ...
    with open('./best_model/best_run_id.txt', 'w') as f:
        f.write(best_run_id)

    with open('./best_model/best_model.pkl', 'wb') as f: 
        pickle.dump(model, f)

    create_confusion_matrix(y_test, pred, path = f'./best_model/test_confusion_matrix.png', set = 'Test')
    plot_roc_curve(y_test, pred_proba, path = f'./best_model/test_roc_curve.png', set = 'Test')
    plot_pr_curve(y_test, pred_proba, path = f'./best_model/test_pr_curve.png', set = 'Test')